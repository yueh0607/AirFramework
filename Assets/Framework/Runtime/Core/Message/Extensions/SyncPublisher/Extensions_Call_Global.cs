...
namespace AirFramework
{
    public static partial class MessageExtensions
    {
        ...
        public static UnitList<T1> Call<T1>(this IDispatcherOut<ISendMessage<T1>> container)
        {
        ...
        public static UnitList<T2> Call<T1, T2>(this IDispatcherOut<ISendMessage<T1, T2>> container, T1 arg1)
        {
        ...
        public static UnitList<T3> Call<T1, T2, T3>(this IDispatcherOut<ISendMessage<T1, T2, T3>> container, T1 arg1, T2 arg2)
        {
        ...
        public static UnitList<T4> Call<T1, T2, T3, T4>(this IDispatcherOut<ISendMessage<T1, T2, T3, T4>> container, T1 arg1, T2 arg2, T3 arg3)
        {
        ...
        public static UnitList<T5> Call<T1, T2, T3, T4, T5>(this IDispatcherOut<ISendMessage<T1, T2, T3, T4, T5>> container, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
        ...
        public static UnitList<T6> Call<T1, T2, T3, T4, T5, T6>(this IDispatcherOut<ISendMessage<T1, T2, T3, T4, T5, T6>> container, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
        {
