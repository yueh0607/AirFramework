...
namespace AirFramework
{
    ...
    public static class AsyncMonitor
    {
        ...
        /// <returns></returns>
        public static AsyncTask WaitUnlocked(object obj)
        {
            ...
            static IEnumerator WaitUnlockedTask(object obj, AsyncTask task)
            {
                while (true)
                {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static async AsyncTask<LockHandle> Lock(object obj)
        {
            var handle = Framework.Pool.Allocate<LockHandle>();
        ...
        public class LockHandle : PoolableObject
        {
            ...
            /// <returns></returns>
            /// <exception cref="InvalidOperationException"></exception>
            public async AsyncTask Lock(object target)
            {
