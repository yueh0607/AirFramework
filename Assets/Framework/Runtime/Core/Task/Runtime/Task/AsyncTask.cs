...
namespace AirFramework
{
    ...
    public partial class AsyncTask : AsyncTaskBase, IAsyncTask, IAsyncTokenProperty
    {
        /// <summary>
        /// 状态切换
        /// </summary>
        ...
        //public static AsyncTask GetFromPool()
        //{
        ...
        /// 在任务完成时被调用
        /// </summary>
        public event Action<AsyncTask> OnCompleted
        {
            add
            {
                if (!base.IsDone)
    ...
    public partial class AsyncTask<T> : AsyncTaskBase, IAsyncTask<T>, IAsyncTokenProperty
    {
        ...
        public event Action<AsyncTask<T>> OnCompleted
        {
            add
            {
                if (!IsDone)
