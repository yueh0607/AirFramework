...
namespace AirFramework
{
    public static partial class CoTask_Ex
    {
        ...
        /// <returns></returns>
        [DebuggerHidden, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AsyncTask WithToken(this AsyncTask task, out AsyncToken token)
        {
        ...
        /// <returns></returns>
        [DebuggerHidden, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AsyncTask<T> WithToken<T>(this AsyncTask<T> task, out AsyncToken token, Action cancelCallback = null)
        {
            var tok = Framework.Pool.Allocate<AsyncToken>();
            tok.node = task.Token;
            token = tok;
