...
namespace AirFramework
{
    ...
    public static class AsyncMonitor
    {
        ...
        /// <returns></returns>
        public static AirTask WaitUnlocked(object obj)
        {
            ...
            return AirTask.WaitUntil(() => !AsyncMonitor.IsLocked(obj));
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static async AirTask<LockHandle> Lock(object obj)
        {
        ...
        public class LockHandle : PoolableObject
        {
            ...
            /// <returns></returns>
            /// <exception cref="InvalidOperationException"></exception>
            public async AirTask Lock(object target)
            {
