...
namespace AirFramework
{
    public static partial class Extensions
    {
        ...
        public static bool TryCall<T1>(this UnitMessageDispatcherContanier container,out T1 result)
        {
        ...
        public static bool TryCall<T1,T2>(this UnitMessageDispatcherContanier container,T1 arg1 ,out T2 result)
        {
        ...
        public static bool TryCall<T1, T2,T3>(this UnitMessageDispatcherContanier container, T1 arg1,T2 arg2, out T3 result)
        {
        ...
        public static bool TryCall<T1, T2, T3,T4>(this UnitMessageDispatcherContanier container, T1 arg1, T2 arg2,T3 arg3, out T4 result)
        {
        ...
        public static bool TryCall<T1, T2, T3, T4,T5>(this UnitMessageDispatcherContanier container, T1 arg1, T2 arg2, T3 arg3,T4 arg4, out T5 result)
        {
        ...
        public static bool TryCall<T1, T2, T3, T4, T5,T6>(this UnitMessageDispatcherContanier container, T1 arg1, T2 arg2, T3 arg3, T4 arg4,T5 arg5, out T6 result)
        {
